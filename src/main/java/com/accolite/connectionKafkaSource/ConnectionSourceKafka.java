package com.accolite.connectionKafkaSource;
...
public class ConnectionSourceKafka {
    private static final Logger log = LoggerFactory.getLogger(ConnectionSourceKafka.class);
    ...
    public ConnectionSourceKafka(Properties workerConfig, Properties... connectorConfigs) throws Exception {
	...
	public void run() {
	    try {
		startLatch.await();
		ConnectionSourceKafka.this.stop();
	    } catch (InterruptedException e) {
